    ...
    <TiltCard max={8} className="relative w-full max-w-md [transform-style:preserve-3d]">
      <div className="relative overflow-hidden rounded-none border border-ink/10 bg-panel p-7 text-panel-foreground shadow-[0_30px_80px_-30px_rgba(23,22,24,0.6)]">
        ...
        <div className="relative flex items-center justify-between">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs font-medium text-panel-foreground/80">
            <Radio size={12} className="text-volt-bright" />
            streaming now
          </div>
          <span className="font-mono text-xs text-panel-foreground/40">stream #0042</span>
        </div>

        <div className="relative mt-8">
          <p className="text-xs uppercase tracking-widest text-panel-foreground/40">
            earned this month
          </p>
        ...
        <div className="relative mt-8 grid grid-cols-2 gap-4">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
            <p className="text-xs text-panel-foreground/40">rate</p>
            <p className="mt-1 font-mono text-sm">$1,500 / day</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
            <p className="text-xs text-panel-foreground/40">runway</p>
        ...
        <p className="relative mt-3 text-center text-xs text-panel-foreground/35">
